        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="all-blog-posts">
              ...
              <?php
$count=1;
$sel_query2="Select short_title,long_title,text,Date from postes ;";
                ...
                <div class="col-lg-6">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span><?php echo $row["short_title"]; ?></span>
                      <a href="post-details.html"><h4><?php echo $row["long_title"]; ?></h4></a>
                      <ul class="post-info">
